                ...
                <div class="card-body table-responsive p-0" >
                    <table class="table table-hover table-bordered dataTable text-nowrap">
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlentities_view($item['module']); ?></td>
                            <td><?php echo htmlentities_view($item['code']); ?></td>
                            <td><?php echo htmlentities_view($item['sort_number']); ?></td>
                            <td><?php echo htmlentities_view($item['create_time']); ?></td>
                            <td><?php echo htmlentities_view($item['update_time']); ?></td>
