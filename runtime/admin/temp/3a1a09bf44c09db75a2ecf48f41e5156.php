...
<section class="content">
    ...
    <option value="<?php echo htmlentities_view($item['id']); ?>" <?php if(isset($data) && $data['user_level_id']==$item['id']): ?>selected<?php endif; ?>>
        <?php echo htmlentities_view($item['name']); ?>
    </option>
...
<div class="form-group row">
    ...
    <div class="col-sm-10 col-md-4 formInputDiv">
        <input id="username" name="username" value="<?php echo htmlentities_view((isset($data['username']) && ($data['username'] !== '')?$data['username']:'')); ?>" placeholder="请输入账号" type="text" class="form-control fieldText">
    </div>
</div>
<div class="form-group row">
    <label for="password" class="col-sm-2 col-form-label">密码</label>
    <div class="col-sm-10 col-md-4 formInputDiv">
        <input id="password" name="password" value="<?php echo htmlentities_view((isset($data['password']) && ($data['password'] !== '')?$data['password']:'')); ?>" placeholder="请输入密码" type="password" class="form-control fieldPassword">
    </div>
</div>
<div class="form-group row">
    <label for="mobile" class="col-sm-2 col-form-label">手机号</label>
    <div class="col-sm-10 col-md-4 formInputDiv">
        <input id="mobile" name="mobile" value="<?php echo htmlentities_view((isset($data['mobile']) && ($data['mobile'] !== '')?$data['mobile']:'')); ?>" placeholder="请输入手机号" type="tel" maxlength="11" class="form-control fieldMobile">
    </div>
</div>
<div class="form-group row">
    <label for="nickname" class="col-sm-2 col-form-label">昵称</label>
    <div class="col-sm-10 col-md-4 formInputDiv">
        <input id="nickname" name="nickname" value="<?php echo htmlentities_view((isset($data['nickname']) && ($data['nickname'] !== '')?$data['nickname']:'')); ?>" placeholder="请输入昵称" type="text" class="form-control fieldText">
    </div>
</div>
    <div class="form-group row">
        ...
        <div class="col-sm-10 col-md-4 formInputDiv"> 
            <div class="input-group">
                <input id="avatar_file" name="avatar_file" type="file" class="file-loading " data-initial-preview="<?php if(isset($data)): ?><?php echo htmlentities_view($data['avatar']); ?><?php endif; ?>">
                <input name="avatar" id="avatar" value="<?php echo htmlentities_view((isset($data['avatar']) && ($data['avatar'] !== '')?$data['avatar']:'')); ?>" hidden placeholder="请上传图片" class="fieldImage">
                <script>
    ...
    <div class="col-sm-10 col-md-4 formInputDiv">
    <input class="input-switch"  id="status" value="1" <?php if((!isset($data) ||$data['status']==1)): ?>checked<?php endif; ?> type="checkbox" />
    <input class="switch fieldSwitch" placeholder="是否启用" name="status" value="<?php echo htmlentities_view((isset($data['status']) && ($data['status'] !== '')?$data['status']:'1')); ?>" hidden />
    </div>
</div>
