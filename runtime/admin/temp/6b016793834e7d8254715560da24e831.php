            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header dataSearch">
                        <form class="searchForm form-inline" id="searchForm" action="<?php echo url('index'); ?>" method="GET">
                            <div class="input-group input-group-sm searchGroup">
                                <input value="<?php echo htmlentities_view((isset($_keywords) && ($_keywords !== '')?$_keywords:'')); ?>" name="_keywords" id="_keywords" class="form-control input-sm"
                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive p-0" >
                        <table class="table table-hover table-bordered dataTable text-nowrap">
                            ...
                            <tr>
                                <td>
                                    <label for="dataItem<?php echo htmlentities_view($item['id']); ?>" class="dataCheckLabel"></label>
                                    <input type="checkbox" onclick="checkThis(this)" name="dataCheckbox"
                                           data-id="<?php echo htmlentities_view($item['id']); ?>" class="checkbox dataListCheck" value="<?php echo htmlentities_view($item['id']); ?>"
                                           placeholder="选择/取消" id="dataItem<?php echo htmlentities_view($item['id']); ?>">
                                </td>
                                ...
                                <td>
                                    <?php if(is_array($item['role_list']) || $item['role_list'] instanceof \think\Collection || $item['role_list'] instanceof \think\Paginator): if( count($item['role_list'])==0 ) : echo "" ;else: foreach($item['role_list'] as $key=>$item_role): ?>
                                    <span class="badge bg-primary "><?php echo htmlentities_view((isset($item_role['name']) && ($item_role['name'] !== '')?$item_role['name']:'')); ?></span>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-warning btn-xs AjaxButton" data-toggle="tooltip" title="禁用"
                                       data-id="<?php echo htmlentities_view($item['id']); ?>" data-confirm-title="禁用确认"
                                       data-confirm-content='您确定要禁用ID为 <span class="text-red"><?php echo htmlentities_view($item['id']); ?></span> 的数据吗'
                                       data-url="<?php echo url('disable'); ?>">
                                    ...
                                    <button class="btn btn-success btn-xs AjaxButton" data-toggle="tooltip" title="启用"
                                       data-id="<?php echo htmlentities_view($item['id']); ?>" data-confirm-title="启用确认"
                                       data-confirm-content='您确定要启用ID为 <span class="text-red"><?php echo htmlentities_view($item['id']); ?></span> 的数据吗'
                                       data-url="<?php echo url('enable'); ?>">
