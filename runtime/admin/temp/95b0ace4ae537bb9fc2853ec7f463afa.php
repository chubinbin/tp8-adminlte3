<?php /*a:16:{s:58:"D:\0WNMP\www\1tp8-adminlte3\app\admin\view\user\index.html";i:1679022656;s:59:"D:\0WNMP\www\1tp8-adminlte3\app\admin\view\public\base.html";i:1679022656;s:63:"D:\0WNMP\www\1tp8-adminlte3\app\admin\view\public\head_css.html";i:1679022656;s:62:"D:\0WNMP\www\1tp8-adminlte3\app\admin\view\public\head_js.html";i:1679022656;s:68:"D:\0WNMP\www\1tp8-adminlte3\app\admin\view\public\navbar\navbar.html";i:1689584611;s:65:"D:\0WNMP\www\1tp8-adminlte3\app\admin\view\public\navbar\nav.html";i:1689584257;s:73:"D:\0WNMP\www\1tp8-adminlte3\app\admin\view\public\navbar\search_form.html";i:1679022656;s:69:"D:\0WNMP\www\1tp8-adminlte3\app\admin\view\public\navbar\message.html";i:1679022656;s:74:"D:\0WNMP\www\1tp8-adminlte3\app\admin\view\public\navbar\notification.html";i:1679022656;s:71:"D:\0WNMP\www\1tp8-adminlte3\app\admin\view\public\navbar\user_menu.html";i:1679022656;s:76:"D:\0WNMP\www\1tp8-adminlte3\app\admin\view\public\navbar\sidebar_button.html";i:1679022656;s:62:"D:\0WNMP\www\1tp8-adminlte3\app\admin\view\public\sidebar.html";i:1679022656;s:69:"D:\0WNMP\www\1tp8-adminlte3\app\admin\view\public\content_header.html";i:1679022656;s:66:"D:\0WNMP\www\1tp8-adminlte3\app\admin\view\public\change_page.html";i:1679022656;s:61:"D:\0WNMP\www\1tp8-adminlte3\app\admin\view\public\footer.html";i:1679022656;s:70:"D:\0WNMP\www\1tp8-adminlte3\app\admin\view\public\control_sidebar.html";i:1679022656;}*/ ?>
...
<div class="row">
            ...
            <div class="card-header dataSearch">
                <form class="form-inline searchForm" id="searchForm" action="<?php echo url('index'); ?>" method="GET">
                    ...
                    <div class="input-group input-group-sm searchGroup">
                        <input value="<?php echo !empty($_keywords) ? htmlentities_view($_keywords) :  '' ;; ?>"
    ...
    <select name="user_level_id" id="user_level_id" class="form-control input-sm index-search">
        ...
        <option value="<?php echo htmlentities_view($item['id']); ?>" <?php if(isset($user_level_id) && ''!==$user_level_id && $user_level_id==$item['id']): ?>selected<?php endif; ?>><?php echo htmlentities_view($item['name']); ?></option>
...
<div class="input-group input-group-sm searchGroup smallSelect">
                        <select name="status" id="status" class="form-control input-sm index-search">
                            ...
                            <option value="<?php echo htmlentities_view($key); ?>" <?php if(isset($status) && ''!==$status && $status==$key): ?>selected<?php endif; ?>><?php echo htmlentities_view($value); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <script>
    ...
    <select name="_order" id="_order" class="form-control input-sm index-order">
        ...
        <option value="id" <?php if(isset($_order) && $_order=='id'): ?>selected<?php endif; ?>>ID</option><option value="create_time" <?php if(isset($_order) && $_order=='create_time'): ?>selected<?php endif; ?>>创建时间</option>
    </select>
</div>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header dataImport">
                <form class="form-inline importForm" id="importForm" action="<?php echo url('import'); ?>" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="form-group importGroup">
                        <a href="<?php echo url('import',['action'=>'download_example']); ?>" target="_blank" class="btn btn-sm btn-default" type="button">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">
                    <div>
                        <a title="添加新数据" data-toggle="tooltip" class="btn btn-primary btn-sm "  href="<?php echo url('add'); ?>">
    <i class="fa fa-plus"></i> 添加
</a>
                        <button class="btn btn-danger btn-sm AjaxButton" data-toggle="tooltip" title="删除选中数据" data-confirm-title="删除确认" data-confirm-content="您确定要删除选中的数据吗？" data-id="checked" data-url="<?php echo url('del'); ?>">
    <i class="fa fa-trash"></i> 删除
</button>
                        <button class="btn btn-success btn-sm AjaxButton" data-toggle="tooltip" title="启用选中数据" data-confirm-title="启用确认" data-confirm-content="您确定要启用选中的数据吗？" data-id="checked" data-url="<?php echo url('enable'); ?>">
    <i class="far fa-circle"></i> 启用
</button>

<button class="btn btn-warning btn-sm AjaxButton" data-toggle="tooltip" title="禁用选中数据" data-confirm-title="禁用确认" data-confirm-content="您确定要禁用选中的数据吗？" data-id="checked" data-url="<?php echo url('disable'); ?>">
    ...
    <input id="dataCheckAll" type="checkbox" onclick="checkAll(this)" class="checkbox" placeholder="全选/取消">
            ...
            <th>创建时间</th>
                        ...
                        <tr>
                            <td>
    <input type="checkbox" onclick="checkThis(this)" name="dataCheckbox" data-id="<?php echo htmlentities_view($item['id']); ?>" class="checkbox dataListCheck" value="<?php echo htmlentities_view($item['id']); ?>" placeholder="选择/取消">
</td>
                                        <td><?php echo htmlentities_view($item['id']); ?></td>
            <td><?php echo htmlentities_view((isset($item['user_level']['name']) && ($item['user_level']['name'] !== '')?$item['user_level']['name']:'')); ?></td>
            <td><?php echo htmlentities_view($item['username']); ?></td>
            <td><?php echo htmlentities_view($item['mobile']); ?></td>
            <td><?php echo htmlentities_view($item['nickname']); ?></td>
<td class="imgViewer"><img class="dataListImg" src="<?php echo htmlentities_view($item['avatar']); ?>"></td>
<td><?php echo htmlentities_view($item['status_text']); ?></td>
            <td><?php echo htmlentities_view($item['create_time']); ?></td>
                            ...
                            <td class="td-do">
                                ...
                                <button class="btn btn-danger btn-xs AjaxButton" data-toggle="tooltip" title="删除"  data-id="<?php echo htmlentities_view($item['id']); ?>" data-confirm-title="删除确认" data-confirm-content='您确定要删除ID为 <span class="text-red"><?php echo htmlentities_view($item['id']); ?></span> 的数据吗' data-url="<?php echo url('del'); ?>">
    <i class="fas fa-trash-alt"></i>
    删除
</button>
                                <?php if($item['status']==1): ?>
<button class="btn btn-warning btn-xs AjaxButton" data-toggle="tooltip" title="禁用"  data-id="<?php echo htmlentities_view($item['id']); ?>" data-confirm-title="禁用确认" data-confirm-content='您确定要禁用ID为 <span class="text-red"><?php echo htmlentities_view($item['id']); ?></span> 的数据吗' data-url="<?php echo url('disable'); ?>">
    <i class="fas fa-ban"></i>
    禁用
</button>
<?php else: ?>
<button class="btn btn-success btn-xs AjaxButton" data-toggle="tooltip" title="启用"  data-id="<?php echo htmlentities_view($item['id']); ?>" data-confirm-title="启用确认" data-confirm-content='您确定要启用ID为 <span class="text-red"><?php echo htmlentities_view($item['id']); ?></span> 的数据吗' data-url="<?php echo url('enable'); ?>">
...
<?php endif; ?>
                ...
                <div class="card-footer">
                    <?php echo $page; ?>
                    <label class="control-label float-right" style="margin: 3px 20px;">
    <small>共<?php echo htmlentities_view($total); ?>条记录</small>&nbsp;
    <small>每页显示</small>

    <select class="input-sm" onchange="changePerPage(this)">
        <option value="10" <?php if($admin['admin_list_rows']==10): ?>selected<?php endif; ?>>10</option>
        <option value="20" <?php if($admin['admin_list_rows']==20): ?>selected<?php endif; ?>>20</option>
        <option value="30" <?php if($admin['admin_list_rows']==30): ?>selected<?php endif; ?>>30</option>
        <option value="50" <?php if($admin['admin_list_rows']==50): ?>selected<?php endif; ?>>50</option>
        <option value="100" <?php if($admin['admin_list_rows']==100): ?>selected<?php endif; ?>>100</option>
    </select>
