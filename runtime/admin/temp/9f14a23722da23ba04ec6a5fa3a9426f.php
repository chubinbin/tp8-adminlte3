    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title">【<?php echo $data->name; ?>】授权</h3>
