                    ...
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle" alt="头像"
                                 src="<?php echo htmlentities_view((isset($data['avatar']) && ($data['avatar'] !== '')?$data['avatar']:'/static/admin/images/avatar.png')); ?>">
                        </div>

                        <h3 class="profile-username text-center"><?php echo htmlentities_view((isset($data['nickname']) && ($data['nickname'] !== '')?$data['nickname']:'')); ?></h3>

                        <p class="text-muted text-center"><?php echo htmlentities_view((isset($data['username']) && ($data['username'] !== '')?$data['username']:'')); ?></p>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 col-md-4 formInputDiv">
                                                <input type="text" class="form-control"
                                                       id="nickname" name="nickname" value="<?php echo htmlentities_view((isset($data['nickname']) && ($data['nickname'] !== '')?$data['nickname']:'')); ?>"
                                                       placeholder="请输入昵称">
